...
<!-- AJAX CALL -->
	...
	<script> function ShowAllAppointments(){ 
	...
	xmlhttp.open("GET","getFavorites.php?logedin=true",true); 
	xmlhttp.send(); } 
	</script>
 ...
 <ul class="w3-navbar w3-theme-d2 w3-left-align w3-large">
  ...
  <li class="w3-hide-small w3-dropdown-hover w3-right">
    ...
    <div class="w3-dropdown-content w3-white w3-card-4" style="right:0">
		...
		<a href="home.html" class="btn btn-info btn-lg"><span class="glyphicon glyphicon-log-out"></span> SignOut</a>
    </div>
  </li>
 </ul>
</div>
...
function removeFavorites(id)
{
	...
	$.get("remove_from_fav.php", {pat_id: $patientID , doc_id: $doctorID})	 
	 .done(function(data) {
		alert(data);
  	    window.location.replace("favorites.php");
  })
  .fail(function() {
