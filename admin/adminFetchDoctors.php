...
//if($logedin != "false")
//{
echo "<button id = 'deleteIcon". $i . "' onclick=\"deleteDoctor('" . $i . "')\" class='w3-btn w3-theme w3-right'>Delete Doctor</button>";
//}
echo "<p><strong>Doctor Name : </strong>" . $row['FirstName'] . " " . $row['LastName'] ; 
echo "<hr class=\"w3-clear\">";
echo "<p><strong>Specialization : </strong>" . $row['Specialization'] . "</p>";
echo "<p><strong>Available Days : </strong>" . $row['AvailableDays'] . "<br>";
echo "<strong>Office Hours : </strong>" . $row['OfficeHoursFrom'] . " - " . $row['OfficeHoursTo'] . "<br>";

echo "<strong>Phone : </strong>" . $row['PhoneNumber'] . "<br>"; 
echo "<strong>Email : </strong>" . "<h7 id = 'drEmail" . $i . "'>" . $row['Email'] . "</h7><br>";
...
echo "<button id = 'updateIcon". $i . "' onclick =\"updateDoctor('" . $i . "')\" class=\"w3-btn w3-theme-d2 w3-margin-bottom w3-right\">Update	Info</button>";
$i = $i + 1;
echo "</div>";
} 
//echo "</div> </div>";
